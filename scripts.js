...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        let previousCompany = null; // Track previous company for duplicate logo check
        if (data.professionalExperience) {
            data.professionalExperience.forEach((experience, index) => {
                const experienceDiv = document.createElement('div');
                experienceDiv.className = 'experience-item';

                // Only add logo if it's not the same as the previous company
                ...
                previousCompany = experience.company; // Update previous company
